<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="online-order.aspx.cs" Inherits="HMSWebOrdering.online_order" %>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="online-order.aspx" class="nav-link active">Online Order</a>
                                        </li>
                                        <li class="nav-item">
