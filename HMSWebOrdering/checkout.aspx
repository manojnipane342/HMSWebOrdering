<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkout.aspx.cs" Inherits="HMSWebOrdering.checkout" %>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="checkout.aspx" class="nav-link active">Checkout</a>
                                        </li>
                                        <li class="nav-item">
