<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cart.aspx.cs" Inherits="HMSWebOrdering.cart" %>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="cart.aspx" class="nav-link active">Cart</a>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="container">
                <div class="cart-wrap">
                    ...
                    <div class="total-shopping">
                        ...
                        <a href="checkout.aspx">Checkout Items</a>
                    </div>
                </div>
            </div>
        </section>
