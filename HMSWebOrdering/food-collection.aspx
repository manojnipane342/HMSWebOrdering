<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="food-collection.aspx.cs" Inherits="HMSWebOrdering.food_collection" %>
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <a href="food-collection.aspx" class="nav-link active">Food Collection</a>
                                        </li>
                                        <li class="nav-item">
