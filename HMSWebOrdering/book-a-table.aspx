<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book-a-table.aspx.cs" Inherits="HMSWebOrdering.book_a_table" %>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="book-a-table.aspx" class="nav-link active">Book A Table</a>
                                        </li>
                                        <li class="nav-item">
