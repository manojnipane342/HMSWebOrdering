<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="service-details.aspx.cs" Inherits="HMSWebOrdering.service_details" %>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="service-details.aspx" class="nav-link active">Service Details</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-7">
                        <div class="page-title-plate">
                            <ul>
                                <li>
                                    <img src="assets/img/service-details/food1.png" alt="Plate">
                                </li>
                                <li>
                                    <img src="assets/img/service-details/food2.png" alt="Plate">
                                </li>
                                <li>
                                    <img src="assets/img/service-details/food3.png" alt="Plate">
                                </li>
                                <li>
                                    <img src="assets/img/service-details/food4.png" alt="Plate">
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="service-details-item">
                            ...
                            <div class="service-details-order">
                                ...
                                <img src="assets/img/service-details/order.png" alt="Service">
                                <div class="offer-off">
                                    <span>20%</span>
                                    <span>OFF</span>
                                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="service-details-item">
                            <div class="service-details-fresh">
                                ...
                                <a class="cmn-btn" href="contact-us.aspx">Reservation</a>
                            </div>
                        </div>
                    </div>
                </div>
